...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2024 at 07:59 AM
...
--
ALTER TABLE `tbl_afia_gmp_records`
  MODIFY `PK_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `tbl_afia_gmp_records_details`
--
ALTER TABLE `tbl_afia_gmp_records_details`
  MODIFY `PK_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1520;
COMMIT;
